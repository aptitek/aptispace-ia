...
### 1. [Fondations de l'IA & Data : Nettoyer les écuries d'Augias des CSV](cours/1_introduction/index.qmd) 🧹
...
### 2. [Deep Learning & Vision : Apprendre à voir dans les matrices](cours/2_reseaux_de_neurones/index.qmd) 👁️
...
### 3. [NLP & GenAI : Murmurer à l'oreille des Transformers](cours/3_genai/index.qmd) 💬
...
### 4. [Orchestration & Agents : Quand le code prend le contrôle](cours/4_orchestration/index.qmd) 🤖
...
### 5. [Gouvernance, Éthique et Sécurité : Les Nouveaux Paradigmes de l'IA](cours/5_ethique/index.qmd) ⚖️
