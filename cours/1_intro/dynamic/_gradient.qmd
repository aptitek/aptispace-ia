...
viewof controls = {
  ...
  const container = html`<div style="display: flex; align-items: flex-end; gap: 40px; width: 100%; margin-bottom: 10px;">
    <div style="flex: 1;">${momentumInput}</div>
    <div style="flex: 0 0 auto; margin-bottom: 15px;">${btn}</div>
  </div>`;
